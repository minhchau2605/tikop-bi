<template>
  ...
  <div class="content">
    <BaseBlock content-full>
      <div class="row">
        <div class="col-lg-12">
          <BaseBlock title="Báo cáo Tổng quan Số tiền Nạp rút và AuM sản phẩm Bất động sản của All user" content-full
...
export default {
      ...
      datasets: [
        {
          label: "Số tiền nạp",
          fill: true,
          backgroundColor: "rgba(21,106,210,0.5)",
          borderColor: "rgba(21,106,210,0.5)",
        ...
        },
        {
          label: "Số tiền rút",
          fill: true,
          backgroundColor: "rgba(234,86,11,0.5)",
          borderColor: "rgba(234,86,11,0.5)",
  ...
  methods: {
    fetch() {
      this.store.fetchAum();
      this.aum = this.store.aum;
      console.log('aum', Object.keys(this.aum).length)
    }
  }
}
</script>
